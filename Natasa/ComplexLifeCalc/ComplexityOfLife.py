...
if gender.lower() == "female" or gender.lower() == "f" or gender.lower() == "girl" or gender.lower() == "woman":
	genderperc = 100
	print "For a %s, life is full of boring stuff, waiting on someone to make them complicated! "%gender,
...
if status.lower() == "single":
	...
	print "Boring! Good thing about being boring is that it's not that complicated...yet!"
	statusperc = 20
elif status.lower() == "in open relationship" or status.lower() == "in an open relationship":
	...
	print "What does that even mean? This is more complicated than the 'it's complicated' relationship!"
	statusperc = 90
else:
	statusperc = 100
...
if ignorance.lower() == "I live in a bubble" or ignorance.lower() == "bubble":
	...
	print "Ooops! Your answer confuses me."
	print "Just give us a number between 0 and 100, where 100 means \n 'completely aware' and 0 makes you a 'bubblehead'"
...
if int(money_spent) < 1000:
	moneyspentperc = 0
elif int(money_spent) >= 1000 and int(money_spent) <= 10000:
	moneyspentperc = 40
...
if int(popularity_online) <= 10:
	popularityperc = 0
	print "You don't appear to be too popular. On the bright side, it reduces  human relationships related complications"
	...
	popularityperc = 100
	print "Guess you're an extrovert huh? Or famous. Or both..."
...
if int(rl_friends) < 3:
	rl_friendsperc = 0
	print "You don't seem to have a lot of friends, which reduces your human relationships related complications."
...
You have %d EUR but you wish you had %d EUR. You would probably get there sooner if you didn' spend %d EUR so far.
